...
export default function EditorialBanner() {
  ...
  const subtitle = t["collection.businessman.desc"] || "Erkekliğin cesur ifadesi.";
  const cta = t["home.hero.discover"] || "Koleksiyonu Keşfet";
  const imageAlt = t["banner.businessman.alt"] || "Businessman koleksiyonu editorial görseli";

  return (
    <section className="relative w-full overflow-hidden" style={{ aspectRatio: "21/9" }} aria-label="Businessman koleksiyon banner">
