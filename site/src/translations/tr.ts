export const tr: Record<string, string> = {
  ...
  "header.menu.mystery": "Gizemli, Çekici & Kendine Has",
  "header.menu.celebrity": "Işıltılı, Coşkulu & Cüretkar",
  "header.menu.majesty": "Asil, Efsanevi & Otoriter",
  "header.menu.dreamy": "Etkileyici, Büyüleyici & Özgün",
  "header.menu.shiny": "Doğal, Ferah & Canlı",
  ...
  "product.mystery.desc": "Mystery, her sabah aynı kadın olmayı reddedenlerin kokusudur. Sıradan bir günü bile büyüleyici bir an'a dönüştürür; sizi tanıyanları düşündürür, tanımayanları merak uyandırır. Fark ettirmeden iz bırakmanın, anlaşılmak yerine hissettirmenin sessiz gücüdür.",
  "product.dreamy.desc": "Bir odaya girdiğinde herkesin dikkatini çeken ama bunu çaba harcamadan yapan kadına yazılmıştır. Vizyoner bir duruş, rafine bir anlayış ve kendinden emin bir zarafetle yoğrulmuş bu koku; sizi hatırlatan değil, akıllardan çıkmayan bir iz bırakır.",
  "product.celebrity.desc": "Sahne senin olduğunda giyilen koku. Geceyi sahiplenen, enerjisiyle etrafını aydınlatan, görünmek ve görülmek için var olan kadının imzası. Canlı, cesur ve unutulmaz, tıpkı onun gibi!",
  "product.majesty.desc": "Majesty, bazı gecelere sıradan bir parfüm yetmez dedirten o nadide koku. Yalnızca özel anlar için saklanan, odaya girişiyle bile bir atmosfer yaratan bir kraliçenin sessiz bildirisidir. Gösteriş değil, hakimiyet!",
  "product.shiny.desc": "Shiny, hareketin, güneşin ve özgürlüğün kokusudur. Sahilde rüzgara karşı duran, yaşamı dolu dolu içine çeken kadına eşlik eder. Hafif ama kalıcı, neşeli ama sofistike! Hayatın en güzel anlarının parfümü.",
  ...
  "scent.Bergamot": "Bergamot",
  "scent.Geranium": "Geranyum",
  "scent.Sage": "Adaçayı",
  "scent.Oak Moss": "Meşe Yosunu",
  "scent.Vetiver": "Vetiver",
  "scent.Tonka Bean": "Tonka Fasulyesi",
  "scent.Grapefruit": "Greyfurt",
  "scent.Juniper Berry": "Ardıç Tohumu",
  "scent.Green Tea Accord": "Yeşil Çay Akoru",
  "scent.Kashmir Wood": "Kashmir Odunu",
  "scent.Violet Leaves": "Menekşe Yaprakları",
  "scent.Iris": "Süsen (İris)",
  "scent.Amber": "Kehribar",
  "scent.Black Pepper": "Siyah Biber",
  "scent.Ginger": "Zencefil",
  "scent.Cardamom": "Kakule",
  "scent.Incense": "Tütsü",
  "scent.Suede": "Süet Deri",
  "scent.Cocoa": "Kakao",
  "scent.Labdanum": "Labdanum",
  "scent.Oud": "Oud",
  "scent.Lemon": "Limon",
  "scent.Mint": "Nane",
  "scent.Green Apple": "Yeşil Elma",
  "scent.Marine Accord": "Deniz Esintisi",
  "scent.White Musk": "Beyaz Misk",

  // Smartwoman Scent Notes
  "scent.Pink Pepper": "Pembe Biber",
  "scent.Silkwood Blossom": "İpek Ağacı Çiçeği",
  "scent.Jasmine Sambac": "Yasemin Sambac",
  "scent.Whipped Cream": "Krem Şanti",
  "scent.Vanilla": "Vanilya",
  "scent.Chestnut": "Kestane",
  "scent.Sandalwood": "Sandal Ağacı",
  "scent.Cashmere Wood": "Kaşmir Odunu",
  "scent.Saffron": "Safran",
  "scent.Jasmin": "Yasemin",
  "scent.Amberwood": "Amber Odunu",
  "scent.Ambergris": "Ambergris",
  "scent.Fir Resin": "Çam Reçinesi",
  "scent.Cedar": "Sedir Ağacı",
  "scent.Pear": "Armut",
  "scent.Rose": "Gül",
  "scent.Lavender": "Lavanta",
  "scent.Ylang Ylang": "Ylang Ylang",
  "scent.Jasmine": "Yasemin",
  "scent.Musk": "Misk",
  "scent.Moss": "Yosun",
  "scent.Pitahaya": "Pitahaya",
  "scent.Red Peony": "Kırmızı Şakayık",
  "scent.Frangipani": "Frangipani",
  "scent.Patchouli": "Paçuli",
  "scent.Mandarin Orange": "Mandalina",
  "scent.Black Currant": "Siyah Frenk Üzümü",
  "scent.Petitgrain": "Petitgrain",
  "scent.Orange Blossom": "Portakal Çiçeği",
  "scent.Madagascar Vanilla": "Madagaskar Vanilyası",
