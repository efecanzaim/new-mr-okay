...
export const products: Product[] = [
  ...
  // SMARTWOMAN - MYSTERY
  {
    ...
    images: [
      "/products/mystery.png",
      "/products/mystery_hover.png",
      "/products/mystery_detail1.png",
      "/products/mystery_detail2.png",
    ],
    category: "smartwoman",
    subcategory: "mystery",
    scent: {
  ...
  // SMARTWOMAN - CELEBRITY
  {
    ...
    images: [
      "/products/celebrity.png",
      "/products/celebrity_hover.png",
      "/products/celebrity_detail1.png",
      "/products/celebrity_detail2.png",
    ],
    category: "smartwoman",
  ...
  // SMARTWOMAN - MAJESTY
  {
    ...
    images: [
      "/products/majesty.png",
      "/products/majesty_hover.png",
      "/products/majesty_detail1.png",
      "/products/majesty_detail2.png",
    ],
    category: "smartwoman",
    subcategory: "majesty",
    scent: {
  ...
  // SMARTWOMAN - DREAMY
  {
    ...
    images: [
      ...
      "/products/dreamy_detail1.png",
      "/products/dreamy_detail2.png",
    ],
    category: "smartwoman",
    subcategory: "dreamy",
    scent: {
  ...
  // SMARTWOMAN - SHINY
  {
    ...
    images: [
      ...
      "/products/shiny_detail1.png",
      "/products/shiny_detail2.png",
    ],
    category: "smartwoman",
    subcategory: "shiny",
    scent: {
